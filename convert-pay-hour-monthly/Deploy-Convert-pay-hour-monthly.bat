...
ECHO ---
ECHO ON
gcloud app deploy "C:\Users\julia\OneDrive\App Engine and More\convert-pay-hour-monthly\FilesToDeploy\app.yaml" --project convert-pay-hour-monthly --verbosity info