...
ECHO ---
ECHO ON
gcloud app deploy "C:\Users\julia\OneDrive\App Engine and More\milliamps-watts\my-nodejs-service\app.yaml" --project milliamps-watts --no-promote --verbosity info
PAUSE